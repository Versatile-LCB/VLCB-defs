...
namespace Merg.Vlcb
{
    ...
    public static class VlcbDefs
    {
        ...
        public static class VlcbMergModuleTypes
        {
			...
			public const int MTYP_CANGATEX	=  89;	// Logic module using boolean logic gates (Duncan Greenwood)
			public const int MTYP_CANGATEXL	=  90;	// Extended version of CANGATEX (Duncan Greenwood)
        ...
        public static class VlcbOpCodes
        {
			...
			public const int OPC_DTXC	=  0xE9;	// RFC0005 Long message packet
			public const int OPC_LM	=  0xEA;	// VLCB Long message packet
        ...
        public static class VlcbCanHardware
        {
			...
			public const int CAN_HW_RP2040_PIO	=  0x08;	// RP2040 using PIO
